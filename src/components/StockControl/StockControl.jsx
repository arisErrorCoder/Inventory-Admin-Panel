...
const StockControl = () => {
  ...
  const handleTemporaryStockChange = (productId, sizeIndex, newStock) => {
    setPendingUpdates((prev) => {
      ...
      if (existingUpdateIndex > -1) {
        const updated = [...prev];
        updated[existingUpdateIndex].newStock = newStock;
        return updated;
      }
      return [...prev, { productId, sizeIndex, newStock }];
    });
  };
  ...
  return (
    <div className="stock-inventory-container">
      ...
      {/* Mobile Design (Only for smaller devices) */}
                ...
                {product.sizes.map((size, index) => (
                  <div key={index} className="size-row">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTemporaryStockChange(product.itemcode, index, Number(e.target.value))
                      }
      ...
      {/* Desktop Design (Only for larger screens) */}
